...
@OnlyIn(Dist.CLIENT)
public class OxygenBubbleDistributorT2GuiWindow extends AbstractContainerScreen<OxygenBubbleDistributorT2Gui.GuiContainer> {
    ...
    public OxygenBubbleDistributorT2GuiWindow(OxygenBubbleDistributorT2Gui.GuiContainer container, Inventory inventory, Component text) {
    ...
    public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
        ...
        OxygenBubbleDistributorT2BlockEntity blockEntity = (OxygenBubbleDistributorT2BlockEntity) this.getMenu().getBlockEntity();
    ...
    protected void renderBg(PoseStack ms, float p_97788_, int p_97789_, int p_97790_) {
        ...
        OxygenBubbleDistributorT2BlockEntity blockEntity = this.getMenu().getBlockEntity();
