...
import com.therealm18studios.beyond_planets_machines.registries.ScreenRegistry;
...
public class OxygenBubbleDistributorT1Gui {

    public static class GuiContainerFactory implements IContainerFactory<GuiContainer> {
        public GuiContainer create(int id, Inventory inv, FriendlyByteBuf extraData) {
            BlockPos pos = extraData.readBlockPos();
            OxygenBubbleDistributorT1BlockEntity blockEntity = (OxygenBubbleDistributorT1BlockEntity) inv.player.level.getBlockEntity(pos);
            return new GuiContainer(id, inv, blockEntity);
        }
    }

    public static class GuiContainer extends AbstractContainerMenu {
        private OxygenBubbleDistributorT1BlockEntity blockEntity;

        public GuiContainer(int id, Inventory inv, OxygenBubbleDistributorT1BlockEntity blockEntity) {
            super(ContainerRegistry.OXYGEN_BUBBLE_DISTRIBUTOR_T1_GUI.get(), id);
        ...
        public OxygenBubbleDistributorT1BlockEntity getBlockEntity() {
