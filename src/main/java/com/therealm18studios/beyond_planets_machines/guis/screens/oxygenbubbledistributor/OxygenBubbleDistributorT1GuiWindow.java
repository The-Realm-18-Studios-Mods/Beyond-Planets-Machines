...
@OnlyIn(Dist.CLIENT)
public class OxygenBubbleDistributorT1GuiWindow extends AbstractContainerScreen<OxygenBubbleDistributorT1Gui.GuiContainer> {
    ...
    public OxygenBubbleDistributorT1GuiWindow(OxygenBubbleDistributorT1Gui.GuiContainer container, Inventory inventory, Component text) {
    ...
    public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
        ...
        OxygenBubbleDistributorT1BlockEntity blockEntity = (OxygenBubbleDistributorT1BlockEntity) this.getMenu().getBlockEntity();
    ...
    protected void renderBg(PoseStack ms, float p_97788_, int p_97789_, int p_97790_) {
        ...
        OxygenBubbleDistributorT1BlockEntity blockEntity = this.getMenu().getBlockEntity();
    ...
    protected void init() {
        ...
        button_plus = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos + 5, 0, 20, 20, 0, 0, 0, false, null, null, TECHNIK_BUTTON_PLUS, LIGHT_TECHNIK_BUTTON_PLUS, 20, 20, (p_2130901) -> {
            ...
            BeyondEarthMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorT1BlockEntity.ChangeRangeMessage(pos, true));
        }));
        ...
        button_minus = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos + 25, 0, 20, 20, 0, 0, 0, false, null, null, TECHNIK_BUTTON_MINUS, LIGHT_TECHNIK_BUTTON_MINUS, 20, 20, (p_2130901) -> {
            BlockPos pos = this.getMenu().getBlockEntity().getBlockPos();
            BeyondEarthMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorT1BlockEntity.ChangeRangeMessage(pos, false));
        }));
        ...
        workingAreaVisibleButton = this.addRenderableWidget(new ImageButtonPlacer(this.leftPos - 20, this.topPos - 22, 0, 34, 20, 0, 0, 0, false, null, null, TECHNIK_BUTTON, LIGHT_TECHNIK_BUTTON, 34, 20, e -> {
            BlockPos pos = this.getMenu().getBlockEntity().getBlockPos();
            BeyondEarthMod.PACKET_HANDLER.sendToServer(new OxygenBubbleDistributorT1BlockEntity.ChangeWorkingAreaVisibleMessage(pos, !this.cachedWorkingAreaVisible));
        }));
    }
