...
@OnlyIn(Dist.CLIENT)
public class SolarPanelT2GuiWindow extends AbstractContainerScreen<SolarPanelT2Gui.GuiContainer> {

    public static final ResourceLocation texture = new ResourceLocation(BeyondEarthMod.MODID, "textures/screens/solar_panel.png");

    public SolarPanelT2GuiWindow(SolarPanelT2Gui.GuiContainer container, Inventory inventory, Component text) {
    ...
    protected void renderLabels(PoseStack ms, int p_97809_, int p_97810_) {
        ...
        SolarPanelT2BlockEntity blockEntity = this.getMenu().getBlockEntity();
