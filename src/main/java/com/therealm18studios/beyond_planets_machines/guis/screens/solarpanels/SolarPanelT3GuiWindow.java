...
@OnlyIn(Dist.CLIENT)
public class SolarPanelT3GuiWindow extends AbstractContainerScreen<SolarPanelT3Gui.GuiContainer> {

    public static final ResourceLocation texture = new ResourceLocation(BeyondEarthMod.MODID, "textures/screens/solar_panel.png");

    public SolarPanelT3GuiWindow(SolarPanelT3Gui.GuiContainer container, Inventory inventory, Component text) {
    ...
    protected void renderLabels(PoseStack ms, int p_97809_, int p_97810_) {
        ...
        SolarPanelT3BlockEntity blockEntity = this.getMenu().getBlockEntity();
