...
public class OxygenBubbleDistributorT1Block extends AbstractMachineBlock<OxygenBubbleDistributorT1BlockEntity> {

    public OxygenBubbleDistributorT1Block(BlockBehaviour.Properties properties) {
        super(properties);
    }
