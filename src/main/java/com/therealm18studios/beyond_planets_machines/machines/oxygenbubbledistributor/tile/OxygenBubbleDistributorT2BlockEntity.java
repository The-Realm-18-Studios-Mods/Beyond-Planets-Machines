...
import com.therealm18studios.beyond_planets_machines.guis.screens.oxygenbubbledistributor.OxygenBubbleDistributorT2Gui;
...
public class OxygenBubbleDistributorT2BlockEntity extends OxygenMakingBlockEntity {
    ...
    public OxygenBubbleDistributorT2BlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntitiesRegistry.OXYGEN_BUBBLE_DISTRIBUTOR_T2_BLOCK_ENTITY.get(), pos, state);
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory) {
        return new OxygenBubbleDistributorT2Gui.GuiContainer(id, inventory, this);
    }
    ...
    protected void createPowerSystems(PowerSystemRegistry map) {
        ...
        map.put(new PowerSystemEnergyCommon(this) {
            ...
            public int getBasePowerForOperation() {
                return OxygenBubbleDistributorT2BlockEntity.this.getBasePowerForOperation();
            }
        });
    }
    ...
    public static class ChangeRangeMessage {
        ...
        public static void handle(ChangeRangeMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
            ...
            OxygenBubbleDistributorT2BlockEntity blockEntity = (OxygenBubbleDistributorT2BlockEntity) context.getSender().level.getBlockEntity(message.getBlockPos());
