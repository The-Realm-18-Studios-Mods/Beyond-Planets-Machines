...
public class SolarPanelT3BlockEntity extends GeneratorBlockEntity {

    public static final int ENERGY_PER_TICK = 2560;

    public SolarPanelT3BlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntitiesRegistry.SOLAR_PANEL_T3_BLOCK_ENTITY.get(), pos, state);
    }

    @Override
    public AbstractContainerMenu createMenu(int id, Inventory inventory) {
        return new SolarPanelT3Gui.GuiContainer(id, inventory, this);
    }
